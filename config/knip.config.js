...
module.exports = {
  ...
  ignoreDependencies: [
    ...
    "@types/react-redux",
    // These are used in tsconfig.json extends but knip doesn't detect it
    "@tsconfig/next",
    "@tsconfig/strictest",
    // Workspace package consumed as TypeScript source
    "@numize/shared-schemas",
    "@numize/ui",
    // Used via @numize/ui package
    "@tailwindcss/postcss",
    "postcss",
  ],
  ignoreBinaries: [
    "tsc", // TypeScript is installed at workspace root
  ],
};
